...
@section('content')
    ...
    @can ('manage-adverts')
        <div class="d-flex flex-row mb-3">
            ...
            <a href="{{ route('admin.adverts.adverts.attributes', $advert) }}" class="btn btn-primary mr-1">Attributes</a>
    ...
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-10">
                        <div style="height: 400px; background: #f6f6f6; border: 1px solid #ddd">
                            <img src="{{ Storage::disk('public')->url($advert->photos->first()->file) }}" alt="" width="100%" height="100%">
                        </div>
                    </div>
                    <div class="col-2">
            ...
            <div class="d-flex flex-row mb-3">
                ...
                <button type="button" class="btn btn-primary phone-button mr-1" id="phone-button" data-source="{{ route('adverts.phone', $advert) }}"><span class="fa fa-phone"></span> <span class="number">Show Phone Number</span></button>
