...
Breadcrumbs::register('cabinet.adverts.edit', function (Crumbs $crumbs, Advert $advert) {
    $crumbs->parent('cabinet.home');
    $crumbs->push('Adverts', route('cabinet.adverts.edit', $advert));
});

Breadcrumbs::register('cabinet.adverts.photos', function (Crumbs $crumbs, Advert $advert) {
    $crumbs->parent('cabinet.home');
    $crumbs->push('Adverts', route('cabinet.adverts.photos', $advert));
});

Breadcrumbs::register('cabinet.adverts.attributes', function (Crumbs $crumbs, Advert $advert) {
    $crumbs->parent('cabinet.home');
    $crumbs->push('Adverts', route('cabinet.adverts.attributes', $advert));
});
